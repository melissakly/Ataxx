...
class Move {
    ...
    boolean isExtend() {
        int rowLocation = Math.abs(row1() - row0());
        int colLocation = Math.abs(col0() - col1());
        if (rowLocation == 0 && colLocation == 0) {
            return false;
        }
        return rowLocation <= 1 && colLocation <= 1;
    }
    ...
    public String toString() {
        ...
        char[] moveArray = {_col0, _row0, '-', _col1, _row1};
        String moveString = new String(moveArray);
        return moveString;
    }
